...
public class CategoryService {
	private final CategoryRepository categoryRepository;	// 【インスタンス変数】
	
	// 【コンストラクタ】
	public CategoryService(CategoryRepository categoryRepository) {
		this.categoryRepository=categoryRepository;		// 【インスタンス初期化】
	}
	...
	// 指定されたキーワードをカテゴリ名に含むカテゴリをページングされた状態で取得する
	...
	// idが最も大きいカテゴリを取得する
	public Category findForstCategoryByOrderByIdDesc() {
	...
	public void createCategory(CategoryRegisterForm categoryRegisterForm) {
		...
		category.setName(categoryRegisterForm.getName());	// カテゴリ名
